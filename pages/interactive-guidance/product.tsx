...
const Page: LayoutPage = () => (
  <>
    ...
    <Fieldset legend="The product is:" hint="put a helpful hint here">
      <ControlGroup block>
    ...
    <Fieldset legend="The product is in a consignment for export to:" hint="put a helpful hint here">
      <ControlGroup block>
        <Checkbox name="product-consignment">weighing less than 10kg,</Checkbox>
    ...
    <Fieldset legend="The product is imported into Australian territory and" hint="put another helpful hint here">
      <ControlGroup block>
